...
{{-- example uses tailwind version 2.0 --}}

{{-- This offers a cleaner syntax that allows us to use a default "transition" utility or add our own properties --}}
        ...
        <header class="border-t-4 border-blue-700 bg-white shadow-md">
            <nav class="container mx-auto px-4 flex items-center justify-between py-4">
                ...
                <div class="relative" x-data="{ isOpen: false }">
                    ...
                    <ul
                      {{-- Much cleaner syntax  --}}
                        x-show.transition.duration.1000ms.opacity.scale.25.origin.top.right.out.duration.2000ms="isOpen"
